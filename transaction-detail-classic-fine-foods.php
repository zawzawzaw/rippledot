  ...
  <div id="page-transaction-detail-banner-fullpage-section">
    ...
    <article id="page-transaction-detail-banner-section">
          ...
          <div class="col-md-12">
            ...
            <div id="page-transaction-detail-banner-image" class="visible-md visible-lg">
              <div class="manic-image-container">
                <img src="" data-image-desktop="images_cms/transaction/transaction-detail-banner-classic-fine-foods.jpg">
              </div>
            </div>
      ...
      <div id="page-transaction-detail-banner-image-mobile" class="visible-sm visible-xs">
        <div class="manic-image-container">
          <img src="" 
            data-image-tablet="images_cms/transaction/transaction-detail-banner-classic-fine-foods-tablet.jpg"
            data-image-mobile="images_cms/transaction/transaction-detail-banner-classic-fine-foods-mobile.jpg">
        </div>
      </div>
              ...
              <div class="col-md-6">
                ...
                <div id="page-transaction-detail-content">
                  ...
                  <div id="page-transaction-detail-copy">
                    <div class="default-copy">
                      <p>CFF is a leading premium food service business headquartered in Singapore and represents the brands of some of the world’s top food producers. CFF is focused on serving chefs in premium restaurants and hotels across its 12 markets and 25 cities in Asia, the Middle East and the U.K.</p>
                    </div>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-10">
                ...
                <div class="page-transaction-detail-related-item-mobile">
                  <a href="transaction-detail-seksun-supernova.php" class="related-item-mobile-image">
                    <div class="manic-image-container">
                      <img src="" data-image="images_cms/transaction/transaction-index-seksun-supernova.jpg">
                    </div>
                  </a>

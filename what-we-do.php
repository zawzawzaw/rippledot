  ...
  <article id="page-what-we-do-intro-section">
    ...
    <div id="page-what-we-do-intro-image-mobile" class="visible-sm visible-xs">
      <div class="manic-image-container">
        <img src="" 
          data-image-tablet="images_cms/transaction/what-we-do-introduction-tablet.jpg"
          data-image-mobile="images_cms/transaction/what-we-do-introduction-mobile.jpg">
      </div>
      ...
      /*<div class="row">
        <div class="col-md-5 col-tablet-landscape-6 hidden-sm hidden-xs">
          ...
          <div id="page-what-we-do-intro-image">
            <div class="manic-image-container">
              <img src="" data-image-desktop="images_cms/transaction/what-we-do-introduction.jpg">
            </div>
          ...
          <div id="page-what-we-do-intro-content">
            ...
            <div id="page-what-we-do-intro-introduction">
              <div class="default-copy">
                <p>Rippledot Capital and its executives have a long and proven track record of delivering successful outcomes for our clients.</p>
              </div>
            ...
            <div id="page-what-we-do-intro-copy">
              <div class="default-copy">
                ...
                <p>Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tell us.</p>
              </div>
      ...
      <div class="row">
        <div class="col-md-12 col-md-push-0 col-sm-10 col-sm-push-1 col-xs-12 col-xs-push-0">
          ...
          <div id="page-what-we-do-expertise-title">
            <h2>Expertise In Your Sector</h2>
            <p>Rippledot Capital provides a full range of corporate advisory and financial services, including:</p>

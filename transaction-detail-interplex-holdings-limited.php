  ...
  <div id="page-transaction-detail-banner-fullpage-section">
    ...
    <article id="page-transaction-detail-banner-section">
          ...
          <div class="col-md-12">
            ...
            <div id="page-transaction-detail-banner-image" class="visible-md visible-lg">
              <div class="manic-image-container">
                <img src="" data-image-desktop="images_cms/transaction/transaction-detail-banner-interplex-holdings-limited.jpg">
              </div>
            </div>
      ...
      <div id="page-transaction-detail-banner-image-mobile" class="visible-sm visible-xs">
        <div class="manic-image-container">
          <img src="" 
            data-image-tablet="images_cms/transaction/transaction-detail-banner-interplex-holdings-limited-tablet.jpg"
            data-image-mobile="images_cms/transaction/transaction-detail-banner-interplex-holdings-limited-mobile.jpg">
        </div>
      </div>
                ...
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <div class="page-default-title">
                      <h4>Our expertise</h4>
                      <h1>Interplex <br>Holdings <br>Limited</h1>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4 col-xs-12">
                      ...
                      <div class="default-detail-item">
                        <h4>Industry</h4>
                        <p>Precision Component Manufacturing</p>
                      </div>
                    ...
                    <div class="col-sm-4 col-xs-6">
                      ...
                      <div class="default-detail-item">
                        ...
                        <p>US$567m</p>
                        <!-- <div class="subtitle">Implied enterprise value</div> -->
                      </div>
              ...
              <div class="col-md-6">
                ...
                <div id="page-transaction-detail-content">
                  ...
                  <div id="page-transaction-detail-copy">
                    <div class="default-copy">
                      <p>Interplex is a leading provider of complex precision mechanical and electro-mechanical components and assemblies to a diverse range of industries including automotive, information technology, industrial, telecom, consumer electronics, imaging and printing and medical and life sciences.</p>
                      <p>Headquartered in Singapore, Interplex has 12,000 employees in approximately 40 facilities in 13 countries worldwide. The business achieved revenues of about US$1 billion for the financial year ending 30 June 2015.</p>
                    </div>

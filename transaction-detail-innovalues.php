  ...
  <div id="page-transaction-detail-banner-fullpage-section">
    ...
    <article id="page-transaction-detail-banner-section">
          ...
          <div class="col-md-12">
            ...
            <div id="page-transaction-detail-banner-image" class="visible-md visible-lg">
              <div class="manic-image-container">
                <img src="" data-image-desktop="images_cms/transaction/transaction-detail-banner-innovalues.jpg">
              </div>
            </div>
      ...
      <div id="page-transaction-detail-banner-image-mobile" class="visible-sm visible-xs">
        <div class="manic-image-container">
          <img src="" 
            data-image-tablet="images_cms/transaction/transaction-detail-banner-innovalues-tablet.jpg"
            data-image-mobile="images_cms/transaction/transaction-detail-banner-innovalues-mobile.jpg">
        </div>
      </div>
                ...
                <div id="page-transaction-detail-content">
                  ...
                  <div id="page-transaction-detail-intro">
                    <div class="default-copy">
                      <p>We advised Innovalues Limited on its sale to Northstar Group and its privatisation from the Singapore Stock Exchange following a competitive global tender process.</p>
                    </div>
                  </div> <!-- page-transaction-detail-intro -->

                  <div id="page-transaction-detail-copy">
                    <div class="default-copy">
                      <p>Headquartered in Singapore, Innovalues is a leading supplier of high-precision, customised machined components to market leaders in the fast-growing automotive sensor, engine and transmission industries. It employs over 1,600 employees in eight strategically-located, vertically-integrated and cost-competitive manufacturing facilities in Malaysia, Thailand and China. Innovalues’ ability to serve its long-tenured, blue-chip customers is anchored by its extensive capabilities, outstanding quality control and cost-competitive pricing. Its services include product design, tooling, machining, plating, heat treatment, secondary processing, inspection and assembly.</p>
                    </div>

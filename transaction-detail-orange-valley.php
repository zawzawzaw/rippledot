  ...
  <div id="page-transaction-detail-banner-fullpage-section">
    ...
    <article id="page-transaction-detail-banner-section">
          ...
          <div class="col-md-12">
            ...
            <div id="page-transaction-detail-banner-image" class="visible-md visible-lg">
              <div class="manic-image-container">
                <img src="" data-image-desktop="images_cms/transaction/transaction-detail-banner-orange-valley.jpg">
              </div>
            </div>
      ...
      <div id="page-transaction-detail-banner-image-mobile" class="visible-sm visible-xs">
        <div class="manic-image-container">
          <img src="" 
            data-image-tablet="images_cms/transaction/transaction-detail-banner-orange-valley-tablet.jpg"
            data-image-mobile="images_cms/transaction/transaction-detail-banner-orange-valley-mobile.jpg">
        </div>
      </div>
                ...
                <div id="page-transaction-detail-content">
                  ...
                  <div id="page-transaction-detail-intro">
                    <div class="default-copy">
                      <p>We advised KV Asia Capital Pte. Ltd. on the sale of Orange Valley Healthcare Pte. Ltd. to Singapore Press Holdings Limited following a competitive global tender process.</p>
                    </div>
                  </div> <!-- page-transaction-detail-intro -->

                  <div id="page-transaction-detail-copy">
                    <div class="default-copy">
                      <p>Orange Valley is the largest private nursing home operator in Singapore with six vertically integrated facilities with a combined bed capacity of about 1,000 -- or almost 25 percent of all private bed capacity in the market. Operationally, Orange Valley is highly differentiated from its peers in its specialty of caring for individuals who require a high degree of nursing care. The group boasts industry-leading clinical capabilities and standards underpinned by one of the most experienced and highly-trained nursing workforces in Singapore.</p>
                    </div>

  ...
  <?php if ($is_debug == true): ?>
    ...
    <script type="text/javascript">
      goog.require('rippledot.page.Whoweare');
    </script>
    ...
    <script type="text/javascript">
      ...
      jQuery(document).ready(function($) {
        page = new rippledot.page.Whoweare({});
      });
  ...
  <?php else: ?>
    ...
    <script type="text/javascript">
      ...
      var PAGE_JS             = "rippledot_assets/js/minified/page-whoweare.min.js";
      ...
      window.head_js.load(PAGE_LIBRARY, function() {
        window.head_js.load(PAGE_JS, function() {
          window.page = new rippledot.page.Whoweare({});
        });
      });
    </script>
